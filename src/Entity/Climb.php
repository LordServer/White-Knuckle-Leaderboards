...
class Climb
{
    ...
    #[ORM\Column(type: 'string', enumType: ClimbStatus::class)]
    private ClimbStatus $status = ClimbStatus::UNREVIEWED;
...
//        }
    ...
    public function getStatus(): ?ClimbStatus
    {
        return $this->status;
    }

    public function setStatus(ClimbStatus $status): static
    {
//        if ($this->isReviewed()) {
//            throw new \LogicException('This entry is locked.');
//        }
